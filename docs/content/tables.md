...
Bootstrap tables are **opt-in**, meaning that you need to use the `.table` class to use these styles, otherwise a table will be plain html.
...
Regular table background variants are not available with the dark table, however, you may use background utilities to achieve similar styles.
...
<!-- TODO: Make these work in vuepress>
