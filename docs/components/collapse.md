...
- label: Bootstrap Docs
  icon: fas fa-book   
  type: info   
  link: 'http://getbootstrap.com/docs/4.1/components/collapse/'
---
...
Using the [card](/fso-bootstrap/components/card) component, you can extend the default collapse behavior to create an accordion.
